            ...
            <div className="flex-1 max-w-[1800px] w-full mx-auto p-6 flex gap-8 overflow-hidden">
                ...
                <div className="flex-1 flex flex-col min-w-0">
                   <div className="flex items-center justify-between mb-4 px-2">
                       <div className="flex items-center gap-2">
                          <FaTerminal className="text-[#0070CD] text-xs" />
                          <span className="text-[10px] font-black uppercase tracking-[.3em] text-slate-400">Main Console Area</span>
                       </div>
                       <div className="flex items-center gap-2 px-3 py-1 bg-emerald-50 text-emerald-600 rounded-lg border border-emerald-100">
                          ...
                          <span className="text-[9px] font-black uppercase tracking-widest">Secure encrypted session</span>
                       </div>
                   </div>
                ...
                <div className="w-80 flex-shrink-0 flex flex-col gap-6 sticky top-0 h-full">
                    <div className="flex items-center gap-2 mb-2 px-4">
                       <span className="text-[10px] font-black uppercase tracking-[.3em] text-slate-400">Patient Intelligence</span>
                    </div>
                    <div className="overflow-y-auto no-scrollbar flex flex-col gap-6">
                       ...
                       <div className="bg-slate-900 rounded-[2.5rem] p-6 text-white shadow-2xl shadow-slate-900/10">
                          <span className="text-[9px] font-black uppercase tracking-[.2em] opacity-50 block mb-4">Quick Toolbox</span>
                          <div className="grid grid-cols-2 gap-3">
                             {[
                               { label: 'Labs', color: 'bg-blue-500' },
                               { label: 'Radiology', color: 'bg-emerald-500' },
                               { label: 'Vitals', color: 'bg-rose-500' },
                               { label: 'Flags', color: 'bg-amber-500' }
                             ].map(tool => (
                               <button key={tool.label} className="p-3 rounded-2xl bg-white/10 hover:bg-white/20 transition-all text-left">
                                  <div className={`w-1.5 h-1.5 rounded-full ${tool.color} mb-2`}></div>
